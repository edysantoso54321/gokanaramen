 ...
 */
public class hapuscustomer extends javax.swing.JFrame {

    /**
     * Creates new form hapuscustomer
     */
    private Object[] rowmenu={"id","nama","alamat","nomortelepon","username"};
    private DefaultTableModel tablemenu= new DefaultTableModel(null,rowmenu);
    public hapuscustomer() {
        initComponents();
        mastertable.setModel(tablemenu);
        Dimension screensize = Toolkit.getDefaultToolkit().getScreenSize();
        setLocation((screensize.width / 2) - (getSize().width / 2), (screensize.height / 2) - (getSize().height / 2));
    }
    public void tampilmenu(ArrayList<customer> a){
        ...
        for (customer x: a){
            ...
            String nomortelepon = x.getnotelp();
            String username=x.getusername();
            Object[] data={id,nama,alamat,nomortelepon,username};
